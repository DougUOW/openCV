...
#same as openCV16a, except now the user can click on individual pixels in the "hsv" image to return 
#the HSV and BGR values of that pixel.

#same as previous, except uses C920
